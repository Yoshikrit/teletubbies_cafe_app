...
public class Order {
    ...
    public Order(int empID , int orderID,ArrayList<String> orderFoodName,ArrayList<Integer> orderQuantity,ArrayList<Food> food,double totalPrice,String orderDate){
        this.empID = empID;
