...
public class GetOrder extends javax.swing.JPanel {
    ...
    public Order getOrderInTable(){
        ...
        for(int i = 0 ; i < numRow ; i++){
            ...
            double mixprice = Double.valueOf(orderTable.getValueAt(i,3).toString());
            double price = (mixprice / qty);
        ...
        double total = Double.valueOf(orderTotalLabel.getText());
        
        /*SimpleDateFormat dateFormat = new SimpleDateFormat("dd_MM_yyyy HH_mm_ss",Locale.ENGLISH);
        Date date = new Date();*/
        
        //order = new Order(empid , orderid , foodname , foodqty , orderdata , total , dateFormat.format(date));
        order = new Order(empid , orderid , foodname , foodqty , orderdata , total , "");
    ...
    public void calPrice(){
        ...
        for(int i = 0 ; i < numRow ; i++){
            Double value = Double.valueOf(orderTable.getValueAt(i,3).toString());
            total += value;
        }
...
//        main.removeAll();
        new PaymentMed(getOrderInTable(),this,main).setVisible(true);
...
//press food
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        double minus = Double.valueOf(rd);
        double total = Double.valueOf(orderTotalLabel.getText());
